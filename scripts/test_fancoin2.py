...
async def punch_in(program: Program, game_pda: Pubkey, game_number: int):
...
async def submit_minting_list(program: Program, game_pda: Pubkey, game_number: int, player_names: list):
...
async def main():
    try:
        ...
        await punch_in(program, game_pda, game_number)
        ...
        await submit_minting_list(program, game_pda, game_number, player_names)
