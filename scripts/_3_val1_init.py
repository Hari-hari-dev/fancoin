...
async def initialize_game_and_mint(program: Program, client: AsyncClient, description: str, socials: str, commission_percent : str, coin_issuance_rate: str, validator_claim_rate: str, gated_val: str, initial_commission_tokens: str):
    """
...
async def main():
    ...
    try:
        ...
        (game_pda, mint_auth_pda, minted_mint_pda, commission_percent, coin_issuance_rate, validator_claim_rate, gated_val, initial_commission_tokens) = await initialize_game_and_mint(program, client, description)
