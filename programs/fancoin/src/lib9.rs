...
//playernamepda should be nonced from a game pda seed
...
// fix this, make per game player lists / counts
#[derive(Accounts)]
...
pub struct RegisterPlayerPda<'info> {
    ...
    //fix, game-based player name bounces, not global for contract
    #[account(
        init,
        payer = user,
...
// --------------------------------------------------------------------
// fix this, mint_pubkey not game number seed
#[derive(Accounts)]
#[instruction(game_number: u32)]
